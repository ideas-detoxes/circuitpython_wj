...
class Server:
  ...
  def cp_start(self, mdns_hostname=None, listen_on=('0.0.0.0', 80), max_parallel_connections=5):
    import wifi
    import socketpool
    if mdns_hostname == None:
        pass
    else:
        import mdns
    ...
    print(f"URL: http://{wifi.radio.ipv4_address}:{listen_on[1]}")
